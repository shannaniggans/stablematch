You are generating the MVP for a SaaS web app called “FullStride” for equine professionals (vets, farriers, physios, trainers). Build a production-ready starter with the following spec.
...
npx create-next-app@latest FullStride --ts --eslint --tailwind --src-dir --app  
cd FullStride  
